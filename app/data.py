...
import random
import logging
from .models import Gender, Country, Frontpage
from app import db
...
def fill_page():
    ...
    {"background":"background:url('static/img/fabric_1.png')","icon":"fa fa-list fa-5x","heading":'AirTag',"sub_heading":'遺失東西的習慣，消失了',"point_1":'讓你超級輕鬆地追蹤你的物品。',"point_2":'呼叫它，找到它。',"point_3":'近，好近，非常近，搵到',"point_4":'多得千千萬萬人的一臂之力',"point_5":'何來神通廣大?',"point_6":'遺失模式，找尋更易找到',"point_7":''},
